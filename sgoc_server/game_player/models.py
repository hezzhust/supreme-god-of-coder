...
from game_setting.models import SettingServantModel,SettingWeaponModel,BaseModel
...
class ServantModel(BaseModel):
    neakname = models.CharField(max_length=100, blank=True, null=True);  # 昵称
...
class WeaponModel(BaseModel):
    setting_prop = models.ForeignKey(SettingWeaponModel, models.DO_NOTHING)
    owner = models.ForeignKey(PlayerModel, models.DO_NOTHING)  # 所有人
    useway = models.IntegerField(default=0); #用途 -1,拆解，0-初始，1-装备
